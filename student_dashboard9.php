...
<body>
  ...
  <aside class="sidebar" id="sidebar">
    <div class="sidebar-header">
      <div class="sidebar-logo">
        <div class="logo-icon" style="background-color: white;"><img src="uploads/internboot.jpg" alt="Internboot Logo"
            style="height: 40px;width: 40px;border-radius:3px;"></div>
        <div>
    ...
    <div class="sidebar-scroll">
      <nav class="sidebar-nav">
        ...
        <ul>
          ...
          <li><a href="#" class="<?= $defaultPage === 'discord' ? 'active' : '' ?>" data-page="discord"
              onclick="return showPage('discord',this)"><i class="fab fa-discord"></i> Join Discord</a></li>
          <li>
  ...
  <main class="main-content">
    ...
    <div class="page-content">
        ...
        <div class="card">
          ...
          <div style="display:flex;gap:12px;flex-wrap:wrap;">
            <button class="btn btn-primary"
              onclick="showPage('profile',document.querySelector('[data-page=profile]'))"><i class="fas fa-user"></i>
              View Profile</button>
            <button class="open-btn"
              onclick="openMaterial('<?= htmlspecialchars($m['file_path']) ?>','<?= $m['file_type'] ?>')">
              Open
            </button>
      ...
      <!--<div id="page-helpSupport" class="content-section">-->
      ...
      <!--        onkeyup="filterHelpTopics(this.value)">-->
      <!--    </div>-->

          <!-- Quick Help Cards -->
      <!--    <div class="quick-help-cards">-->
      <!--      <div class="quick-card" onclick="scrollToSection('faqSection')">-->
      <!--        <i class="fas fa-book-open"></i>-->
      <!--        <h4>FAQs</h4>-->
      <!--        <p>Find quick answers</p>-->
      <!--      </div>-->
      <!--      <div class="quick-card" onclick="scrollToSection('contactSection')">-->
      <!--        <i class="fas fa-envelope"></i>-->
      <!--        <h4>Contact Us</h4>-->
      <!--        <p>Send us a message</p>-->
      <!--      </div>-->
      <!--      <div class="quick-card" onclick="scrollToSection('guideSection')">-->
      <!--        <i class="fas fa-play-circle"></i>-->
      <!--        <h4>User Guide</h4>-->
      <!--        <p>Step-by-step tutorials</p>-->
      <!--      </div>-->
            <!-- <div class="quick-card" onclick="scrollToSection('reportSection')">
      <!--        <i class="fas fa-bug"></i>-->
      <!--        <h4>Report a Bug</h4>-->
      <!--        <p>Let us know about issues</p>-->
      <!--      </div> -->-->
      <!--    </div>-->

          <!-- FAQ Section -->
          <div id="faqSection" class="help-section">
            <h3><i class="fas fa-book-open"></i> Frequently Asked Questions</h3>
            ...
            <div class="faq-category">
              ...
              <div class="faq-item" onclick="toggleFaq(this)">
                ...
                <div class="faq-answer">
                  <p>Go to <strong>Edit Profile</strong> from the sidebar menu. You can update your name, email, phone
                    number, and profile picture. Click <strong>"Save Changes"</strong> when you're done.</p>
                </div>
              </div>
              ...
              <div class="faq-item" onclick="toggleFaq(this)">
                ...
                <div class="faq-answer">
                  <p>Navigate to <strong>Settings → Security</strong>. Enter your current password, then your new
                    password twice to confirm. Click <strong>"Update Password"</strong>.</p>
                </div>
              </div>
              ...
              <div class="faq-item" onclick="toggleFaq(this)">
                ...
                <div class="faq-answer">
                  <p>Yes. Go to <strong>Settings → Account</strong> and click <strong>"Delete Account"</strong>. Please
                    note this action is permanent and all your data will be removed.</p>
                </div>
              </div>
            </div>
            ...
            <div class="faq-category">
              ...
              <div class="faq-item" onclick="toggleFaq(this)">
                ...
                <div class="faq-answer">
                  <p>We accept Visa, MasterCard, American Express, PayPal, and bank transfers. You can manage your
                    payment methods in the <strong>Billing</strong> section.</p>
                </div>
              </div>
              ...
              <div class="faq-item" onclick="toggleFaq(this)">
                ...
                <div class="faq-answer">
                  <p>Refund requests can be submitted within 30 days of purchase. Go to <strong>Billing → Transaction
                      History</strong>, select the transaction, and click <strong>"Request Refund"</strong>.</p>
                </div>
              </div>
            </div>
            ...
            <div class="faq-category">
              ...
              <div class="faq-item" onclick="toggleFaq(this)">
                <div class="faq-question">
                  <span>The page is not loading properly. What should I do?</span>
                  <i class="fas fa-chevron-down faq-icon"></i>
                </div>
                <div class="faq-answer">
                  ...
                  <p>If the problem persists, please <a href="#" onclick="scrollToSection('contactSection')">contact
                      us</a>.</p>
                </div>
              </div>
              ...
              <div class="faq-item" onclick="toggleFaq(this)">
                ...
                <div class="faq-answer">
                  <p>We support the latest versions of Chrome, Firefox, Safari, Edge, and Opera. For the best
                    experience, keep your browser up to date.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <!-- User Guide Section -->
          <div id="guideSection" class="help-section">
            <h3><i class="fas fa-play-circle"></i> User Guide</h3>
            <div class="guide-list">
              ...
              <div class="guide-item">
                ...
                <div class="guide-content">
                  ...
                  <p>After signing up, complete your profile by adding your personal details and profile picture. This
                    helps personalize your experience.</p>
                </div>
              </div>
              ...
              <div class="guide-item">
                ...
                <div class="guide-content">
                  ...
                  <p>Use the sidebar menu to access different sections. The dashboard gives you an overview of your
                    activity, stats, and notifications.</p>
                </div>
              </div>
              ...
              <div class="guide-item">
                ...
                <div class="guide-content">
                  ...
                  <p>Customize your preferences, notifications, privacy, and security settings from the Settings page
                    accessible via the sidebar.</p>
                </div>
              </div>
              ...
              <div class="guide-item">
                ...
                <div class="guide-content">
                  <h4>Getting Help</h4>
                  <p>If you ever need assistance, visit this Help & Support page, browse the FAQs, or send us a message
          ...
          <div id="contactSection" class="help-section">
            ...
            <div class="contact-support-wrapper">
              ...
              <!-- Contact Form -->
              <form class="support-form" id="supportForm" onsubmit="return submitSupportForm(event)">
                <div class="form-row">
                ...
                <div class="form-group">
                  ...
                  <input type="file" id="supportAttachment" accept="image/*,.pdf,.doc,.docx">
                </div>
          ...
          <!-- <div id="reportSection" class="help-section">
            <h3><i class="fas fa-bug"></i> Report a Bug</h3>
            <form class="bug-report-form" id="bugForm" onsubmit="return submitBugReport(event)">

              <div class="form-group">
                <label for="bugTitle">Bug Title</label>
                <input type="text" id="bugTitle" placeholder="Brief title of the issue" required>
              </div>
              ...
              <div class="form-row">
                ...
                <div class="form-group">
                  <label for="bugBrowser">Browser Used</label>
                  <select id="bugBrowser">
              ...
              <button type="submit" class="btn-submit-bug">
                <i class="fas fa-bug"></i> Submit Bug Report
              </button>
            </form>
          </div> -->
      ...
      <section class="content-section <?= $defaultPage === 'studyMaterial' ? 'active' : '' ?>" id="page-studyMaterial">
        <div class="card">
          <div class="card-header">
            ...
            <span style="font-size:13px;color:var(--text-light);"><i class="fas fa-folder"></i> <?= count($materials) ?>
              files available</span>
          </div>
            ...
            <div class="material-grid">
              <?php foreach ($materials as $m):
                ...
                <div class="material-card">
                  ...
                  <div class="file-meta"><?= strtoupper(htmlspecialchars($m['file_type'] ?? 'FILE')) ?> • Uploaded
      ...
      <section class="content-section <?= $defaultPage === 'discord' ? 'active' : '' ?>" id="page-discord">
        <div class="discord-banner">
          ...
          <a href="https://discord.gg/bAyM64DZvD" target="_blank" class="btn-discord"><i class="fab fa-discord"></i>
  ...
  <script>
    ...
    const titles = {
      ...
      certificate: 'Download <span>Certificate</span>', helpSupport: 'Help & <span>Support</span>'
    };
    ...
    window.filterHelpTopics = function (searchTerm) {
    ...
    window.submitSupportForm = function (event) {
      ...
      const subject = formData.get('supportSubject');
      const message = formData.get('supportMessage');
    ...
    window.submitBugReport = function (event) {
      ...
      // Simple validation
      const title = formData.get('bugTitle');
      const severity = formData.get('bugSeverity');
      const steps = formData.get('bugSteps');
    ...
    function openMaterial(path, type) {
      let viewer = document.createElement('div');
      viewer.style.cssText = "position:fixed;top:0;left:0;width:100%;height:100%;background:#000c;z-index:9999;display:flex;align-items:center;justify-content:center;";

      let content = '';
      if (type === 'pdf') {
        content = `<iframe src="${path}#toolbar=0" width="80%" height="80%" style="border:none;background:#fff;border-radius:8px;"></iframe>`;
      } else if (type === 'ppt' || type === 'pptx') {
        content = `<iframe src="https://view.officeapps.live.com/op/embed.aspx?src=${encodeURIComponent(path)}" width="80%" height="80%" frameborder="0" style="border-radius:8px;"></iframe>`;
      } else if (type === 'mp4') {
        content = `<video width="80%" height="80%" controls style="border-radius:8px;background:#000;"><source src="${path}" type="video/mp4"></video>`;
      } else {
        content = `<p style="color:#fff;font-size:16px;">Preview not available.</p>`;
      }

      viewer.innerHTML = content + '<button class="viewer-close" onclick="this.parentNode.remove()">&times;</button>';
